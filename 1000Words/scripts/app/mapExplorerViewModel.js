...
app.MapExplorerViewModel = (function () {
    var viewModel = (function () {
        var map,
            ...
            nesto = kendo.observable({ value: 'false'});
        ...
        var show = function () {
            //alert('show');
            kendo.bind($("#notificationDiv"), app.NotificationsViewModel);
            setTimeout(function(){
                app.NotificationsViewModel.onNotificationReceived();
            }, 2000);
        };
            ...
            geocoder.geocode({
                ...
                if (status == google.maps.GeocoderStatus.OK) {
                    if (results.length > 0) {
                        ...
                        var location = _.find(results, function (value) {
